...
module camera_vga_top(
    ...
    detector_top #(
        ...
        .DILATE(3'd3),
        // *** Update this after running scripts/export_weights.py ***
        // The export script prints "FC_OUT_SHIFT = N" -- paste N here.
        // It's the right-shift that turns FC int32 outputs into patch
        // pixel coordinates.
        .BBOX_SHIFT(10),
