...
# ---------- Add detector weight hex files + scales header ----------
...
# scales.vh is auto-generated by export_weights.py; RTL `includes it for the
# requantization shifts. Register it as a Verilog header and add weights/ to
# the include path so `include "scales.vh" resolves without a full path.
add_files -norecurse $repo_root/weights/scales.vh
set_property file_type "Verilog Header" [get_files scales.vh]
set_property include_dirs [list $repo_root/weights] [current_fileset]
